...
import { ExperienceRow } from "@/src/features/portfolio/components/sections/experience-row";
import { MasterDetail } from "@/src/features/portfolio/components/sections/master-detail";
import { useListNavigation } from "@/src/features/portfolio/hooks/use-list-navigation";
import type { ExperienceEntry } from "@/src/shared/types/portfolio";

export const ExperienceSection: FC = () => {
  const { selected, open, opened, close } = useListNavigation(
