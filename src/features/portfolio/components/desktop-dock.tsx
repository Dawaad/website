...
export const DesktopDock: FC<Props> = ({ visible }) => {
  ...
  return (
    <nav
      aria-label="windows"
      className={cn(
        "fixed top-1/2 left-3 z-40 hidden -translate-y-1/2 flex-col gap-2 border border-fg-4/60 bg-bg-0/80 p-2 shadow-lg backdrop-blur-sm transition-opacity duration-700 ease-out lg:flex",
      ...
      {DESKTOP_WINDOWS.map((w) => {
        ...
        return (
          <button
            ...
            style={{
              boxShadow: open
                ? `0 4px 10px -2px rgba(0,0,0,0.45), inset 0 1px 0 rgba(255,255,255,0.18), inset 0 0 0 1px color-mix(in srgb, ${w.tint} 25%, transparent)`
