...
export const Contact = () => {
    ...
    return (
        <section className="w-full h-[80dvh] items-center  relative py-10">
            {/* <Grid className="z-30 opacity-20" /> */}
            <EnvironmentBackground />
            <article className="w-full h-full items-end justify-end flex z-30">
                <TargetCursor
                    spinDuration={2}
                ...
                />
                <div
                    className="space-y-6  w-full z-30 max-w-3xl"
                    ref={containerRef}
                    data-has-target-cursor="true"
                >
                    <GlassContainer
                        className="rounded-none  p-10 flex flex-col  items-start md:items-end w-full "
                        surfaceClassname="rounded-none md:rounded-md"
                    >
                        <h1 className="text-start sm:text-end lg:text-start text-2xl sm:text-4xl lg:text-5xl font-semibold leading-tight lg:leading-[70px] text-neutral-100">
                            So let's{" "}
                            <span className="bg-amber-500 rounded-lg text-white px-3 py-1 inline-block cursor-target">
                                get in touch?
                            </span>
                        </h1>
                        <div className="text-xs md:text-base text-neutral-200/50 font-medium  sm:text-end w-full leading-tight italic mt-2">
                            <div>Ill be waiting for you to reach out.</div>
                            <div>legs swinging in the air and all that cute shit</div>
                            :p
                        </div>displ
                        <div className="flex flex-col space-y-4 items-center md:items-end w-full mt-12">
