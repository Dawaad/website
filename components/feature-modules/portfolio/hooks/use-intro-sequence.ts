 ...
 */
export function useIntroSequence(contentRef: RefObject<HTMLElement | null>): IntroSequence {
  ...
  return { intro, introBones, introDecode, introClip, decodeDir: DECODE_DIR, beginScramble };
}
