        ...
        >
            ...
            <CommandList className="max-h-[400px]">
                ...
                >
                    ...
                    <Link
                        href="https://twitter.com/Dawaad"
                        target="_blank"
                        onClick={() => setOpen(false)}
                    >
                        <CommandItem className="text-white/90 hover:bg-white/10 data-[selected=true]:bg-white/10 cursor-pointer">
                            <FaXTwitter className="mr-3 size-4" />
                            <span>X</span>
                            <span className="ml-auto text-xs text-white/50">
                                View my X profile
                            </span>
            ...
            <div className="border-t border-white/10 px-4 py-2 text-[10px] text-white/50 flex items-center gap-4">
                <div className="flex items-center gap-1">
                    <kbd className="px-1 py-0.5 bg-white/5 border border-white/20 rounded">↑</kbd>
                    <kbd className="px-1 py-0.5 bg-white/5 border border-white/20 rounded">↓</kbd>
                    <span>navigate</span>
                </div>
                <div className="flex items-center gap-1">
                ...
                <div className="flex items-center gap-1">
                    <kbd className="px-1 py-0.5 bg-white/5 border border-white/20 rounded">esc</kbd>
                    <span>close</span>
                </div>
            </div>
        </CommandDialog>
